...
public final class jpBanHang extends javax.swing.JPanel {
    ...
    public jpBanHang() {
        ...
        bh = this;
        FillBan();
        jButton2.setBackground(Color.decode("#6699ff"));
        jButton1.setBackground(Color.decode("#ffcc66"));
    ...
    public void FillBan(){
        ...
        if(arrBan != null){
            ...
            for(int i=0;i<arrBan.size();i++){
                ...
                btn[i].setBackground(Color.decode("#6699ff"));
                ...
                if(arrBan.get(i).GetTrangThai().equals("Đang phục vụ")){
                    btn[i].setBackground(Color.decode("#ffcc66"));
                }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("BÀN ĐANG PHỤC VỤ");

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel5.setText("BÀN ĐÃ ĐẶT TRƯỚC");
